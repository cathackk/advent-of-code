...
def part_1(masses: Iterable[int]) -> int:
    ...
    **What is the sum of the fuel requirements** for all of the modules on your spacecraft?
        ...
        >>> part_1([12, 14, 1969, 100756])
        part 1: sum of fuel requirements is 34241
        34241
    """

    result = sum(fuel_1(mass) for mass in masses)

    print(f"part 1: sum of fuel requirements is {result}")
    return result


def part_2(masses: Iterable[int]) -> int:
    """
    ...
    subtract 2. However, that fuel **also** requires fuel, and **that** fuel requires fuel, and so
    ...
    **What is the sum of the fuel requirements** for all of the modules on your spacecraft when also
    ...
    separately, then add them all up at the end.)
        ...
        >>> part_2([14, 1969, 100756])
        part 2: sum of recursive fuel requirements is 51314
        51314
    """

    result = sum(fuel_2(mass) for mass in masses)

    print(f"part 2: sum of recursive fuel requirements is {result}")
    return result


def fuel_1(mass: int) -> int:
    return mass // 3 - 2


def fuel_2(mass: int) -> int:
    r = fuel_1(mass)
    return r + fuel_2(r) if r > 0 else 0
